...
author: "Joscelin Rocha Hidalgo - she/her - (@JoscelinRocha) <br /> Grace Goodwin <br /> (pronouns) <br /> (Twitter handle) <br />"
output:
...
Intro to R and Importing Datasets (Yolanda)
...
Data Visualization + Markdown (Grace)
