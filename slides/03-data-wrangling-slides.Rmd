...
.pull-right[![:scale 200%](images/example_2_mutate_select.png)]
...
1. Wrangling time:
    ...
    4. Use **`summarise`** to calculate a new var called **`mean_gestation_w`** by moms' **`age_group`** & **`ed`**
    5. Assign it to a new data frame called **`mothers_below40`**
    5. Export it as a csv!

Bonus: Once you have that data frame just move of the columns around using **"relocate"**
