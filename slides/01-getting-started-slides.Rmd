...
Intro to R & RStudio  (Yolanda)

-- 

Getting Started on Using R/RStudio (Yolanda)

--


Data Manipulation (Joscelin)

--

Data Visualization and RMarkdown (Grace)
...
3) RStudio makes **graphics** accesible. 
...
```
![](images/Make_Comments.png)]

---
## Skill 4.1 - Install Packages

To install packages, use the "install.pacakges" command. See following syntax:
