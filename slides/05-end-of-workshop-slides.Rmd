...
- [CghLewis](https://twitter.com/Cghlewis)
- [@CaraRThompson](https://twitter.com/cararthompson)
...
![:scale 100%](https://raw.githubusercontent.com/allisonhorst/stats-illustrations/master/rstats-artwork/code_hero_rstats.png)
art by @allison_horst]
...
![:scale 80%](images/APAGS_vote_1.jpeg)

---

class: inverse, center, middle, dk-section-title

![:scale 80%](images/APAGS_vote_2.jpeg)

```{r}
renderthis::to_pdf("05-end-of-workshop-slides.Rmd", partial_slides = TRUE)
```