...
author: "Grace J. Goodwin <br /> (she/ her/ hers) <br /> @gracejgoodwin"
output:
...
![:scale 250%](images/esquisse.gif)


```{r}
renderthis::to_pdf("04-data-visualization-intro.Rmd", partial_slides = TRUE)
```
